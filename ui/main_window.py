...
"")
        ...
        icon5 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.ZoomIn))
        ...
        icon8 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.WeatherClear))
        self.actionTheme.setIcon(icon8)
        self.action = QAction(MainWindow)
        self.action.setObjectName(u"action")
        icon9 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.WindowNew))
        ...
        icon12 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.EditClear))
        ...
        icon13 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.DialogInformation))
        self.actionGithub_Link.setIcon(icon13)
...
"}")
        ...
        self.verticalLayout_2.setContentsMargins(-1, -1, 0, 10)
